...
public class ProfileViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.profile_view_capture);
...
//        }
        ...
        cdata = getIntent().getParcelableExtra("data");
...
////                Bitmap bitmap = getScreenBitmap(); // Get the bitmap
        ...
        //check permission
        if (ActivityCompat.checkSelfPermission(ProfileViewActivity.this, android.Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            if (ActivityCompat.shouldShowRequestPermissionRationale(ProfileViewActivity.this, android.Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                ...
                builder.setPositiveButton("Grant", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.cancel();
                        ActivityCompat.requestPermissions(ProfileViewActivity.this, new String[]{android.Manifest.permission.WRITE_EXTERNAL_STORAGE}, EXTERNAL_STORAGE_PERMISSION_CONSTANT);
                    }
                });
